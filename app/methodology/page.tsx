...
export const metadata = { title: 'Time Savings Methodology — CSA Efficiency Dashboard' }
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#FFF8F1' }}>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-12 animate-fade-up">
          <p className="font-caption text-xs mb-2" style={{ color: '#89837C' }}>CSA Automation · Ops Tasking Dashboard</p>
          <h1
          ...
          <p className="text-sm leading-relaxed max-w-2xl" style={{ color: '#767676' }}>
            How we estimate the hours saved per week for a CSA using the Ops Tasking Dashboard — including the honest limits of those estimates and what adoption level is required to hit the headline numbers.
          </p>
        </div>

        {/* Headline claims */}
        <div
          className="rounded-xl p-6 mb-12 animate-fade-up"
          style={{ backgroundColor: '#175242', animationDelay: '40ms' }}
        >
          <p className="font-caption text-xs mb-4" style={{ color: 'rgba(255,255,255,0.5)' }}>Defensible headline claims</p>
        ...
        {/* Section: Core time sinks */}
        <Section
          step="01"
          title="The Core Time Sinks"
          description="Three activities were used as the starting point for estimating manual overhead — before accounting for inflation or double-counting."
          delay="80ms"
        >
          <DataTable
        ...
        {/* Section: Honest reassessment */}
        <Section
          step="02"
          title="Honest Reassessment"
          description="The initial methodology double-counts and inflates frequencies. Three key issues:"
          delay="120ms"
        >
        ...
        {/* Section: Realistic savings */}
        <Section
          step="03"
          title="Realistic Savings Estimate"
          description="After correcting for double-counting and frequency inflation."
          delay="160ms"
        >
          <DataTable
        ...
        <Section
          step="04"
          title="What Each Feature Eliminates"
          description="Before vs. after breakdown for each major capability — and the minimum usage level needed for that feature to move the needle."
          delay="200ms"
        >
        ...
        {/* Section: Minimum usage for 5 hrs */}
        <Section
          step="05"
          title="Minimum Usage to Reach 5 Hours/Week"
          description="The tool needs to be the primary task interface — not a secondary lookup — to hit this threshold."
          delay="240ms"
        >
          <DataTable
        ...
        {/* Section: Conservative scenario */}
        <Section
          step="06"
          title="Conservative Scenario (50% Adoption)"
          description="Even if a CSA uses the tool half the time and still falls back to old habits."
          delay="280ms"
        >
          <DataTable
        ...
        <Section
          step="07"
          title="How to Validate Empirically"
          description="Usage events are already logged in the usage_events table — these steps would let us move from estimates to measured savings."
          delay="320ms"
        >
          <div className="space-y-3">
            {[
              ...
              'Analyze event frequency per user in usage_events to see actual interaction rates and compare to frequency assumptions above.',
            ].map((step, i) => (
              <div key={i} className="flex gap-3">
                <span
                  className="font-caption text-xs mt-0.5 shrink-0 w-5 h-5 rounded-full flex items-center justify-center font-bold"
                  style={{ backgroundColor: '#ECECEC', color: '#767676', fontSize: '10px' }}
                >
                  {i + 1}
                </span>
                <p className="text-sm leading-relaxed" style={{ color: '#4A4440' }}>{step}</p>
              </div>
            ))}
          </div>
        </Section>
...
function Section({
  ...
  return (
    <section className="mb-0 animate-fade-up" style={{ animationDelay: delay }}>
      <div className="flex items-start gap-4 mb-5">
        <span
          className="font-caption text-xs shrink-0 mt-1"
...
function Divider() {
  return <div className="my-10 border-t" style={{ borderColor: '#ECECEC' }} />
}
...
function Callout({
  ...
  return (
    ...
    >
      <span
        className="font-caption text-xs font-bold shrink-0 mt-0.5"
        style={{ color }}
      >
        {label}
      </span>
            ...
            <tr>
              ...
              <td
                ...
                style={{
                  ...
                  color: footerHighlight ? '#175242' : '#1A1A1A',
                  fontSize: '0.9375rem',
                }}
              >
                {footerValue}
...
function FeatureBlock({
  ...
  return (
    <div
      ...
      style={{
        borderColor: highlight ? '#175242' : '#ECECEC',
        backgroundColor: highlight ? '#F4FAF7' : '#FFFFFF',
      }}
    >
      <h3
